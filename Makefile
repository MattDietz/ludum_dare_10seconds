CC=g++
CFLAGS=-I./include -I./include/config_lib -lsfml-window -lsfml-system -lsfml-graphics -lsfml-audio -I./include/config_lib -DSCOUNDREL_COMMAND_LINE=1
...
all: obj/ color.o configfile.o configitem_base.o
